        ...
        <div class="col-md-12">
            <div class="card secbg ">
                <div class="card-body ">
                            ...
                            @forelse($payouts as $key => $item)
                                <tr>
                                    ...
                                    <td data-label="@lang('Amount')">
                                        <strong>{{ (getAmount($item->amount)).' '.$item->payout_currency_code }}</strong>
                                    </td>
                                    <td data-label="@lang('Amount (In Base)')">
                                        <strong>{{ currencyPosition($item->amount_in_base_currency)}}</strong>
                                    </td>
                    ...
                    {{ $payouts->appends($_GET)->links($theme.'partials.pagination') }}
                </div>
            </div>
        </div>
    </div>
                ...
                for (var i = 0; i < information.length; i++) {
                    ...
                    if (information[i][1].type == 'file') {
                        result += `<li class="list-group-item bg-transparent">
                                            <span class="font-weight-bold "> ${information[i][0].replaceAll('_', " ")} </span> : <img class="w-100"src="${information[i][1].field_value ?? information[i][1].field_name}" alt="..." class="w-100">
                                        </li>`;
                    } else {
                        result += `<li class="list-group-item bg-transparent">
                                            <span class="font-weight-bold "> ${information[i][0].replaceAll('_', " ")} </span> : <span class="font-weight-bold ml-3">${information[i][1].field_value ?? information[i][1].field_name}</span>
                                        </li>`;
                    }
                }
