                    ...
                    <div class="table-parent table-responsive m-0">
                        <table class="table table-striped" id="service-table">
                            ...
                            <tr>
                                ...
                                <th scope="col">@lang('Pay Amount')</th>
                            ...
                            @forelse($funds as $key => $data)
                                <tr>
                                    ...
                                    <td data-label="#@lang('Transaction ID')">
                                        <strong>{{$data->trx_id}}</strong>
                                    </td>
                                    <td data-label="@lang('Gateway')">@lang(optional($data->gateway)->name)</td>


                                    <td data-label="@lang('Pay Amount')">
                                        <strong>{{getAmount($data->amount)}} @lang($data->payment_method_currency)</strong>
                                    </td>

                                    <td data-label="@lang('Amount (In Base)')">
                                        <strong>{{currencyPosition($data->payable_amount_in_base_currency)}}</strong>
                                    </td>
