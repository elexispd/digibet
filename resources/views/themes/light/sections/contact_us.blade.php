                ...
                <div class="col-lg-6">
                    <div class="text-box">
                        <div class="header-text">
                            <h5>@lang(@$contact_us['single']['heading'])</h5>
                            <h3>@lang(@$contact_us['single']['sub_heading'])</h3>
                            {!! @$contact_us['single']['short_description'] !!}
                        </div>
                        <div class="row">
                            <div class="info-box col-md-6">
                                ...
                                <div class="text">
                                    <h5>@lang('Address')</h5>
                                    <p>@lang(@$contact_us['single']['address'])</p>
                                </div>
                            </div>
                            <div class="info-box col-md-6">
                                <div class="icon-box">
                                ...
                                <div class="text">
                                    <h5>@lang('House')</h5>
                                    <p>@lang(@$contact_us['single']['house'])</p>
                                </div>
                            </div>
                            <div class="info-box col-md-6">
                                <div class="icon-box">
                                ...
                                <div class="text">
                                    <h5>@lang('Email')</h5>
                                    <p>@lang(@$contact_us['single']['email'])</p>
                                </div>
                            </div>
                            <div class="info-box col-md-6">
                                <div class="icon-box">
                                ...
                                <div class="text">
                                    <h5>@lang('Phone')</h5>
                                    <p>@lang(@$contact_us['single']['phone'])</p>
                                </div>
                            </div>
                        </div>
                    </div>
