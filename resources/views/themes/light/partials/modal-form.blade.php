    ...
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="row g-0">
                <!-- Left Column - Image -->
                <div class="col-md-6">
                    <img src="{{ asset('assets/upload/auth/auth.jpg') }}" alt="Login"
                                ...
                                <div class="row g-4">
                                    <div class="input-box col-12">
                                        <input type="text" autocomplete="off" name="username"
                                            value="{{ old('username', 'demouser') }}" class="form-control"
                                    ...
                                    <div class="input-box col-12">
                                        <input type="password" name="password" value="{{ old('password') }}"
                                            autocomplete="off" class="form-control" placeholder="@lang('Password')" />
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="row g-0">
                    <!-- Left Column - Image -->
                    <div class="col-md-6">
                        <img src="{{ asset('assets/upload/auth/auth.jpg') }}" alt="Register"
                            class="img-fluid w-100 h-100" style="object-fit: cover;">
                    </div>
                    <!-- Right Column - Header & Form -->
                    <div class="col-md-6 d-flex flex-column">
                            ...
                            <div class="w-100">
                                ...
                                <form class="login-form" id="signup-form" action="{{ route('register') }}" method="post">
                                    ...
                                    <div class="row g-4">
                                        ...
                                        <div class="input-box col-12">
                                            <input type="text" autocomplete="off" name="lastname" value="{{ old('lastname') }}"
                                        ...
                                        <div class="input-box col-6">
                                            ...
                                            @endphp
                                            <select class="form-select form-control country_code dialCode-change"
                                                name="phone_code" aria-label="Default select example" id="basic-addon1">
                                        ...
                                        <div class="input-box col-6">
                                            <input type="text" autocomplete="off" name="phone" value="{{ old('phone') }}"
                                                class="form-control dialcode-set" placeholder="@lang('Phone Number')" />
                                    ...
                                    <button type="submit"
                                        class="btn-custom w-100 login-signup-auth-btn">@lang('sign up')</button>
                                    <div class="bottom">
