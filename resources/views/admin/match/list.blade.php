...
@section('page_title','Manage Match')
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Manage Match')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Manage Match')</h1>
                </div>
                    ...
                    @if(adminAccessRoute(config('role.manage_game.access.add')))
                        <a class="btn btn-primary" href="javascript:void(0)" data-bs-target="#newModal"
                           data-bs-toggle="modal">
                            <i class="bi bi-flag me-1"></i> @lang('Add New')
                        </a>
                    @endif
                </div>
            </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Active Match")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$matches['activeMatch']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$matches['totalMatch']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($matches['activeMatchPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("InActive Match")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$matches['inActiveMatch']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$matches['totalMatch']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-danger text-danger p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($matches['inActiveMatchPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Today Created Match")</h6>

                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$matches['todayMatch']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$matches['totalMatch']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-info text-info p-1">
                                <i class="bi-graph-down"></i> {{$matches['todayMatchPercentage']??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("This Month Created Match")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$matches['thisMonthMatch']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">from {{$matches['totalMatch']??0}}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-success text-success p-1">{{fractionNumber($matches['thisMonthMatchPercentage'])??0}}%</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mb-2 mb-md-0">
                            <div class="input-group input-group-merge navbar-input-group">
                                ...
                                <input type="search" id="datatableSearch"
                                       ...
                                       placeholder="@lang('Search Match')"
                                       aria-label="@lang('Search Match')"
                                       autocomplete="off">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="filter_form">
                                                <div class="mb-4">
                                                            <span
                                                                class="text-cap text-body">@lang('Team/Tournament/Category Name')</span>
                                                    <div class="row">
                                                        <div class="col-12">
...
@push('script')
    <script>
        ...
        $(document).on('click', '.delete_btn', function () {
            ...
            $('#deleteModalBody').text('Are you sure you want to proceed with the deletion of this match?');
        ...
        $(document).on('click', '.editBtn', function () {
            ...
            $('.editCategory').val("" + match.category_id).trigger('change');
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route("admin.listMatchSearch")}}",
                },

                columns: [
                    {data: 'checkbox', name: 'checkbox'},
                    {data: 'match', name: 'match'},
                    {data: 'active_question', name: 'active_question'},
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.listMatchSearch") }}" + "?name=" + name +
            ...
            $(document).on('click', '.change-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.matchMultiStatusChange') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
