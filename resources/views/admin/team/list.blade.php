                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Team List')</li>
                        </ol>
                    </nav>
                    <h1 class="page-header-title">@lang('Team List')</h1>
                </div>
                <div class="col-sm-auto">
                    <a class="btn btn-primary" href="javascript:void(0)" data-bs-target="#newModal"
                       data-bs-toggle="modal">
                        <i class="fas fa-users me-1"></i> @lang('Add New')
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Active Team")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$teams['activeTeam']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$teams['totalTeam']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($teams['activeTeamPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("InActive Team")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$teams['inActiveTeam']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$teams['totalTeam']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-danger text-danger p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($teams['inActiveTeamPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Today Created Team")</h6>

                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$teams['todayTeam']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$teams['totalTeam']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-info text-info p-1">
                                <i class="bi-graph-down"></i> {{$teams['todayTeamPercentage']??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("This Month Created Team")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$teams['thisMonthTeam']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">from {{$teams['totalTeam']??0}}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-success text-success p-1">{{fractionNumber($teams['thisMonthTeamPercentage'])??0}}%</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mb-2 mb-md-0">
                            <div class="input-group input-group-merge navbar-input-group">
                                ...
                                <input type="search" id="datatableSearch"
                                       ...
                                       placeholder="@lang('Search Team')"
                                       aria-label="@lang('Search Team')"
                                       autocomplete="off">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="filter_form">
                                                <div class="mb-4">
                                                            <span
                                                                class="text-cap text-body">@lang('Team Name')</span>
                                                    <div class="row">
                                                        <div class="col-12">
...
@push('script')
    <script>
        ...
        $(document).on('click', '.delete_btn', function () {
            ...
            $('#deleteModalBody').text('Are you sure you want to proceed with the deletion of this team?');
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route("admin.listTeamSearch")}}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.listTeamSearch") }}" + "?name=" + name +
            ...
            $(document).on('click', '.change-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.teamMultiStatusChange') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
