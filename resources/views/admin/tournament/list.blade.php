...
@section('page_title','Game Tournament List')
@section('content')
                ...
                <div class="col-sm mb-2 mb-sm-0">
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active" aria-current="page">@lang('Game Tournament List')</li>
                        </ol>
                    </nav>
        ...
        <div class="row">
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Active Tournament")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$tournaments['activeTournament']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$tournaments['totalTournament']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-success text-success p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($tournaments['activeTournamentPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("InActive Tournament")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$tournaments['inActiveTournament']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$tournaments['totalTournament']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-danger text-danger p-1">
                                <i class="bi-graph-up"></i> {{fractionNumber($tournaments['inActiveTournamentPercentage'])??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("Today Created Tournament")</h6>

                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$tournaments['todayTournament']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{$tournaments['totalTournament']??0}}</span>
                            </div>
                            <div class="col-auto">
                              <span class="badge bg-soft-info text-info p-1">
                                <i class="bi-graph-down"></i> {{$tournaments['todayTournamentPercentage']??0}}%
                              </span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-sm-6 col-lg-3 mb-3 mb-lg-5">
                <div class="card h-100">
                    <div class="card-body">
                        <h6 class="card-subtitle mb-2">@lang("This Month Created Tournament")</h6>
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{$tournaments['thisMonthTournament']??0}}</span>
                                <span
                                    class="text-body fs-5 ms-1">from {{$tournaments['totalTournament']??0}}</span>
                            </div>
                            <div class="col-auto">
                                <span class="badge bg-soft-success text-success p-1">{{fractionNumber($tournaments['thisMonthTournamentPercentage'])??0}}%</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="mb-2 mb-md-0">
                            <div class="input-group input-group-merge navbar-input-group">
                                ...
                                <input type="search" id="datatableSearch"
                                       ...
                                       placeholder="@lang('Search Tournament')"
                                       aria-label="@lang('Search Tournament')"
                                       autocomplete="off">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="filter_form">
                                                <div class="mb-4">
                                                            <span
                                                                class="text-cap text-body">@lang('Tournament Name')</span>
                                                    <div class="row">
                                                        <div class="col-12">
    ...
    @include('admin.tournament.modal')
...
@push('script')
    <script>
        ...
        $(document).on('click', '.delete_btn', function () {
            ...
            $('#deleteModalBody').text('Are you sure you want to proceed with the deletion of this tournament?');
        ...
        $(document).on('click', '.editBtn', function () {
            ...
            document.querySelector('#icon').tomselect.setValue(categoryId);
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                serverSide: true,
                ajax: {
                    url: "{{ route("admin.listTournamentSearch")}}",
                },
            ...
            document.getElementById("filter_button").addEventListener("click", function () {
                ...
                datatable.ajax.url("{{ route("admin.listTournamentSearch") }}" + "?name=" + name +
            ...
            $(document).on('click', '.change-multiple', function (e) {
                ...
                $.ajax({
                    ...
                    url: "{{ route('admin.tournamentMultiStatusChange') }}",
                    data: {strIds: strIds},
                    datatType: 'json',
                    type: "post",
