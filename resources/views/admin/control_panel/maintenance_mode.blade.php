                                ...
                                <div class="row mb-4">
                                    <div class="col-md-12">
                                        ...
                                        <textarea class="form-control" name="description"
                                                  id="summernote">{{ old("description", $maintenanceMode->description) }}</textarea>
                                        @error("description")
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        <span class="col-8 col-sm-9 ms-0">
                                          ...
                                          <span
                                              class="d-block fs-5">@lang("Maintenance mode is a feature that allows you to temporarily disable access to your online store's frontend.")</span>
                                        </span><span class="col-4 col-sm-3 text-end">
                                        <input type='hidden' value='0' name='is_maintenance_mode'>
                                          <input type="checkbox" name="is_maintenance_mode" id="maintenanceModeStatus"
