                    ...
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb breadcrumb-no-gutter">
                            ...
                            <li class="breadcrumb-item active"
                                aria-current="page">@lang("In App Notification Setting")</li>
                        </ol>
                    </nav>
            ...
            <div class="col-lg-6 seo-setting">
                <div class="d-grid gap-3 gap-lg-5">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('admin.pusher.config.update') }}" method="post"
                                ...
                                <div class="row mb-4">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="pusherAppKeyLabel"
                                               class="form-label">@lang("Pusher App Key")</label>
                                        <div class="input-group input-group-merge" data-hs-validation-validate-class>
                                            ...
                                            <button type="button" id="pusherAppKey"
                                ...
                                <div class="row mb-4">
                                    <div class="col-sm-6">
                                        <label for="pusherAppSecretLabel"
                                               class="form-label">@lang('Pusher App Secret')</label>
                                        <div class="input-group input-group-merge" data-hs-validation-validate-class>
                                            <input
                                                type="password"
                                            ...
                                            <button type="button" id="pusherAppSecret"
                                                    class="input-group-append input-group-text">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="pusherAppClusterLabel"
                                               class="form-label">@lang('Pusher App Cluster')</label>
                                        <input
                                            type="text"
                                ...
                                <label class="row form-check form-switch mb-4" for="in_app_notification">
                                    ...
                                    <span class="col-4 col-sm-3 text-end">
                                           <input type="hidden" value="0" name="in_app_notification"/>
                                            <input
                                                class="form-check-input @error('in_app_notification') is-invalid @enderror"
                                                type="checkbox" name="in_app_notification" id="in_app_notification"
                                                value="1"
