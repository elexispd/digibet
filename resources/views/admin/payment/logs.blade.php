                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ fractionNumber($paymentRecord[0]['totalPaymentLog'], false) }}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{ fractionNumber($paymentRecord[0]['totalPaymentLog'], false) }}</span>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ $paymentRecord[0]['paymentSuccess'] }}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{ $paymentRecord[0]['totalPaymentLog'] }}</span>
                            </div>
                            <div class="col-auto">
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ $paymentRecord[0]['pendingPayment'] }}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{ $paymentRecord[0]['totalPaymentLog'] }}</span>
                            </div>
                ...
                <div class="card h-100">
                    <div class="card-body">
                        ...
                        <div class="row align-items-center gx-2">
                            <div class="col">
                                <span
                                    class="js-counter display-4 text-dark">{{ $paymentRecord[0]['cancelPayment'] }}</span>
                                <span
                                    class="text-body fs-5 ms-1">@lang("From") {{ $paymentRecord[0]['cancelPayment'] }}</span>
                            </div>
        ...
        $(document).on('ready', function () {
            ...
            HSCore.components.HSDatatables.init($('#datatable'), {
                ...
                columns: [
                    ...
                    {data: 'payable_in_base', name: 'payable_in_base'},
