    ...
    public function getRoleList(Request $request)
    {
        ...
        return DataTables::of($roles)
            ...
            ->addColumn('action',function ($item){
                ...
                $editButton = adminAccessRoute(config('role.manage_staff.access.edit'))?"<a href='javascript:void(0)' class='btn btn-white btn-sm edit_user_btn edit_role_btn' data-bs-toggle='modal' data-bs-target='#EditRoleModal' data-id='$id'>
                        <i class='bi bi-pencil-square dropdown-item-icon'></i> ".trans('Edit')."
                      </a>":'';
                $deleteButton = adminAccessRoute(config('role.manage_staff.access.delete'))?" <a class='dropdown-item loginAccount DeleteBtn' data-route='$deleteUrl' href='javascript:void(0)' data-bs-toggle='modal' data-bs-target='#deleteModal'>
                           <i class='bi bi-trash dropdown-item-icon'></i>
                          ".trans("Delete")."
                        </a>":'';

                if (adminAccessRoute(config('role.manage_staff.access.edit')) || adminAccessRoute(config('role.manage_staff.access.delete'))){
